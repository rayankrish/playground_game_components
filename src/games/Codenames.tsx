...
function WordCard({
  ...
  let border_width = true_color === "ASSASSIN" ? "6" : "4";
  // TODO: Better font
  return (
    <button
      className="codenames-words"
      style={{
...
export function CodenamesGame({
  ...
  return (
    <div className="codenames-container">
      <div className="codenames-role-container space-x-2">
      ...
      {
        <div className="codenames-footer">
          <div>
            <ScoreDisplay
